...
def fill_missing(x: np.array, max_len: int, vary_len: str = "uniform-scaling", normalise: bool = True):
    if vary_len == "zero":
        if normalise:
...
def process_ts_data(x, max_len, vary_len: str = "uniform-scaling", normalise: bool = False):
    """
